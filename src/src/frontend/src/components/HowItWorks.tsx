...
export default function HowItWorks() {
  return (
    <section id="how-it-works" className="py-24 bg-hf-light">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto relative">
          <div className="hidden md:block absolute top-10 left-1/3 right-1/3 h-px bg-primary/20" />
          {STEPS.map((step, idx) => (
            <motion.div
              key={step.step}
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              <div className="relative mb-6">
                ...
                <span className="absolute -top-1 -right-1 w-7 h-7 rounded-full bg-white border-2 border-primary flex items-center justify-center text-primary text-xs font-black">
                  {idx + 1}
                </span>
              </div>
