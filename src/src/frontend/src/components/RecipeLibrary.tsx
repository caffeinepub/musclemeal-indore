...
export default function RecipeLibrary() {
  ...
  return (
    <section id="recipes" className="py-24 bg-card/20">
          ...
          >
            {filtered.map((recipe, idx) => (
              <motion.div
                ...
                className="bg-card border border-border rounded-2xl overflow-hidden card-glow transition-all duration-300 flex flex-col"
              >
                <div className="relative overflow-hidden h-44">
                  ...
                  {recipe.tags.length > 0 && (
                    <div className="absolute top-2 right-2 flex flex-col gap-1">
                      {recipe.tags.map((tag) => (
                        <Badge
                          key={tag}
                          className="text-[10px] py-0 bg-primary/90 text-primary-foreground border-0"
                        >
                          {tag}
                        </Badge>
                      ))}
                  ...
                  <div className="absolute bottom-2 left-2">
                    <Badge
                      variant="outline"
                      className="text-[10px] border-white/20 text-white/80 bg-black/40"
                    >
                      {recipe.cuisine}
                    </Badge>
                  </div>
                ...
                <div className="p-4 flex flex-col flex-1">
                  ...
                  <div className="grid grid-cols-4 gap-1">
                    {[
                      ...
                      <div
                        key={m.label}
                        className="text-center bg-muted/30 rounded-lg py-1.5"
                      >
