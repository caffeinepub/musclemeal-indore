      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-gray-500 mt-3 max-w-md mx-auto">
            Veg / Non-Veg options — weekly or monthly
          </p>
        </motion.div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
          <div className="flex rounded-lg overflow-hidden border border-gray-200">
            <button
              ...
              className={`px-5 py-2.5 text-sm font-bold transition-colors ${isVeg ? "bg-primary text-white" : "bg-white text-gray-600 hover:bg-gray-50"}`}
            >
              🥗 Vegetarian
            </button>
            <button
          ...
          <div className="flex rounded-lg overflow-hidden border border-gray-200">
            <button
              ...
              className={`px-5 py-2.5 text-sm font-bold transition-colors ${isMonthly ? "bg-primary text-white" : "bg-white text-gray-600 hover:bg-gray-50"}`}
            >
              Monthly
            </button>
            <button
          ...
          {PLAN_CARDS.map((plan, i) => {
            ...
            return (
              <motion.div
                ...
                className={`relative rounded-xl overflow-hidden flex flex-col bg-white ${isPopular ? "border-2 border-primary shadow-lg" : "border border-gray-200"}`}
              >
                {isPopular && (
                ...
                <div className="p-6 flex flex-col flex-1">
                  ...
                  <div className="text-sm space-y-1 mb-4">
                    ...
                    <div className="text-primary font-bold">{plan.protein}</div>
                  </div>
                  ...
                  <a
                    ...
                    className="flex items-center justify-center gap-2 bg-primary text-white py-3 rounded-lg text-sm font-black hover:bg-primary/90 transition-colors"
                  >
